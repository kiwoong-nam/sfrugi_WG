...
my $output="$WD/script/assembling.sh";
...
$j.="cd $Bdir\n\n";
$j.="perl ../script/stats.assembly.pl\n";
$j.="perl ../script/stats.throughput.pl\n\n";
...
$j.="bash ../script/stats.busco.sh\n";
$j.="perl ../script/stats.merge.pl\n\n";
