...
vt=read.table('/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/Transducing/mean',h=T)

colnames(vt)[2]='Type'

v1=subset(vt,Type=="nonCNV")
v2=subset(vt,Type=="CNV")
...
p = ggplot(v, aes(x =Type, y = m, group = sample)) +
  ...
  ylab("Proportion of LINE-transduced gene") +
  xlab("") +
  theme_bw() +
...
pdf('/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/Transducing.pdf',width=4.2,height=4.2)
p
dev.off()
