...
for(f in filenames)
{
	v=subset(read.table(paste(ID,f,sep="/")),V6==0)
...
write.table(RES,"/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/structure/length_singleexon.stats",sep="\t",quote=FALSE,row.names=FALSE)
