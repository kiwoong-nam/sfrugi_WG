...
v=read.table('/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/structure/length.txt',h=T)
...
pdf('/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/structure.length.pdf',width=4.2,height=4.2)
p
dev.off()
