...
my $outF='/home/kiwoong/Projects/sfrugi_WG/TRANSPOSITION/structure/length_singleexon.txt';
...
foreach my $f (@files)
{
	...
	$res.="$f\tCNV\t$bg[0]\t$BCNV[975]\t$BCNV[25]\n";
	$res.="$f\tnonCNV\t$bg[1]\t$BnonCNV[975]\t$BnonCNV[25]\n";
